...
export const metadata: Metadata = {
  title: "Neo Caterpi - Genesis Emblems NFT | Portal to Neo Wonderland",
  ...
  openGraph: {
    title: "Neo Caterpi - Genesis Emblems NFT",
    description: "1,500 Genesis Emblems qui éclosent en 10,000 NFTs Caterpi sur Ethereum",
    type: "website",
    locale: "fr_FR",
  },
  twitter: {
